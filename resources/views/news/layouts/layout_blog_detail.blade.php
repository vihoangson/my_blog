              ...
              <div class="row">
                ...
                <div class="col-sm-16 comments-area">
                  ...
                  <div class="opinion pull-left">
                    ...
                    <div class="media"> <a href="#" class="pull-left"> <img alt="64x64" data-src="{{PATH_THEME_NEWS}}holder.js/64x64" class="media-object" style="width: 64px; height: 64px;" src="{{PATH_THEME_NEWS}}images/comments/com-2.jpg"> </a>
                      <div class="media-body">
                        <div>
                          <h4 class="media-heading">John Doe</h4>
                          <div class="time text-danger"><span class="ion-android-data icon"></span>Dec 9 2014</div>
                        ...
                        <div class="col-sm-16"><a href="#"><span class="reply pull-right ion-ios7-compose"></span></a></div>
                        <div class="media nested-rep pull-left"> <a href="#" class="pull-left"> <img alt="64x64" class="media-object" style="width: 64px; height: 64px;" src="{{PATH_THEME_NEWS}}images/comments/com-1.jpg"> </a>
                          <div class="media-body ">
                            <div>
                              <h4 class="media-heading">John Doe</h4>
                              <div class="time text-danger"><span class="ion-android-data icon"></span>Dec 9 2014</div>
